...
<p class="payment_module">
	...
	<form name="myForm" onsubmit="" action="{$link->getModuleLink('pzprestashop', 'validation', [], true)|escape:'html'}" method="post" class="form-horizontal" id="pzprestashopForm">
		<img src="{$this_path_bw}logo.jpg" alt="{l s='Pay by Cloud 10' mod='pzprestashop'}"/>
		<span class="payment-heading">{l s='Pay by Cloud 10' mod='pzprestashop'}</span>
		

			<div class="selection">
			<div class="payment-type">
			<span><label for="paymenttype" class="col-sm-3 control-label">{l s="No payment method found." mod='pzprestashop'} </label></span>
