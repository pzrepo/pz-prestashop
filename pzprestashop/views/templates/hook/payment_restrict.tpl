...
<p class="payment_module">
	...
	<form name="myForm" onsubmit="" action="{$link->getModuleLink('pzprestashop', 'validation', [], true)|escape:'html'}" method="post" class="form-horizontal" id="pzprestashopForm">
		...
		<span class="payment-heading">{l s='Pay by Pzprestashop' mod='pzprestashop'}&nbsp;<span>{l s='(Card Limit Exceeded.)' mod='pzprestashop'}</span></span>
		

			<div class="selection">
			<div class="payment-type">
			<span><label for="paymenttype" class="col-sm-3 control-label">{l s="One of the product exceeds the maximum allowed amount, Please remove some products from One of the Supplier." mod='pzprestashop'} </label></span>
